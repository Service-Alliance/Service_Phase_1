class JobDetailsController < ApplicationController
  ...
  private
    ...
    def job_detail_params
      params.require(:job_detail).permit(:insurance_company_id, :claim_number, :policy_number, :coverage_type_id, :deductible_amount, :self_pay_id, :deductible_id, :esl_nst_amount_id, :emergency_service_amount, :job_id, :billing_type_id, :coverage_type)
    end
    def address_params
