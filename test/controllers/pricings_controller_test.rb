...
class PricingsControllerTest < ActionController::TestCase
  ...
  test "should create pricing" do
    assert_difference('Pricing.count') do
      post :create, pricing: { description: @pricing.description, price: @pricing.price, pricing_category_id: @pricing.pricing_category_id }
    end
  ...
  test "should update pricing" do
    patch :update, id: @pricing, pricing: { description: @pricing.description, price: @pricing.price, pricing_category_id: @pricing.pricing_category_id }
    assert_redirected_to pricing_path(assigns(:pricing))
  end
